...
\begin{table}[h!] 
	\caption{An overview of the properties of each \gls{OGM} generation method based on the examined literature. Exact details of the reasoning behind the qualitative results in the table can be found in sections \ref{subsec:prob_OGM}, \ref{subsec:evid_OGM}, and \ref{subsec:alt_OGM}.}
	\centering
	\resizebox{\linewidth}{!}{%
		\begin{tabular}{llll} 
			\toprule[0.25ex]
