...
\begin{table}[h!]
	...
	\caption{This table contains an overview of properties of the different \gls{OGM} prediction methods. }
...
\begin{table}[H]
	...
	\resizebox{\linewidth}{!}{
		...
		\caption{This table shows the results for each \gls{OGM} prediction methods categorized by the metric(s) that is/are used to evaluate the method. Some methods are trained multiple times using different datasets. In that case, the datasets are mentioned before each result.}
